...
gate_mapping = {
    ...
    "CH": {"qiskit": {"g": qiskit.CHGate}, "pyquil": {"r": "-"}, "qsharp": {"g": "CH"}, "matrix": qiskit.HGate().to_matrix()},
    ...
    "CRX": {"qiskit": {"g": qiskit.CRXGate}, "pyquil": {"r": "-"}, "qsharp": {"g": "CRx"}},
    "RY": {"qiskit": {"g": qiskit.RYGate}, "pyquil": {"g": pyquil.RY}, "qsharp": {"g": "Ry"}},
    "CRY": {"qiskit": {"g": qiskit.CRYGate}, "pyquil": {"r": "-"}, "qsharp": {"g": "CRy"}},
    "RZ": {"qiskit": {"g": qiskit.RZGate}, "pyquil": {"g": pyquil.RZ}, "qsharp": {"g": "Rz"}},
    "CRZ": {"qiskit": {"g": qiskit.CRYGate}, "pyquil": {"r": "-"}, "qsharp": {"g": "CRz"}},
    ...
    "Reset": {"qiskit": {"g": directives.Reset}, "pyquil": {"r": "-"}, "qsharp": {"g": "Reset"}},
    "MReset": {"qiskit": {"r": directives.Measure}, "pyquil": {"r": "-"}, "qsharp": {"g": "MResetZ"}},
